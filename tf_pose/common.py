...
CocoPairs = [
    (1, 2), (1, 5), (2, 3), (3, 4), (5, 6), (6, 7), (2, 8), (8, 9), (9, 10), (5, 11),
...
def get_sample_images(w, h, num_sample_val):
    val_image = [
    ...
    if num_sample_val > 12:
        # TODO: This is a hack to return as many val images as needed
        counter = num_sample_val
        while counter > 12:
            val_image.append(read_imgfile('./images/p1.jpg', w, h))
            counter = counter - 1
